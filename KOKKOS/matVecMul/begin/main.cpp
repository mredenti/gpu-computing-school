...
int main(int argc, char *argv[])
{
    ...
    Kokkos::initialize(argc, argv);
    {
        ...
        /* ------------------ @TASK@: Initialize host Views (you may use a Kokkos::parallel pattern) ----------------------*/
        ...
        // @TASK@: Synchronize [parallel reductions into scalars are synchronous, 
        // but generally you should not rely on blocking behaviour]
